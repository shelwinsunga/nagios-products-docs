...
Now, in the file explorer, right click on `administrators_authorized_keys` and click **Properties** &rarr; **Security** &rarr; **Advanced** &rarr; **Disable Inheritance** &rarr; **Remove all inherited permissions from this object**.
...
After adding the user, check all the permission boxes (except for **Special**). Click **OK** and then **Apply**.
...
Now, on the XI user interface, go to **Admin** &rarr; **System Extensions** &rarr; **Config Wizards** &rarr;.
